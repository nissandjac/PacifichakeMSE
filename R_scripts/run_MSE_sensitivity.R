...
for (i in 1:nruns){
  tmp <- run_multiple_MSEs(simyears = simyears,
                           seeds = seeds[i],
                           TAC = 1, df = df, cincrease = 0, mincrease = 0, TACchange = 2)
...
# # # # #
#
save(ls.save,file = 'results/Climate/MSErun_move_oops_climate_0_02_TAC4.Rdata')
...
# # # # #
#
save(ls.save,file = 'results/Climate/MSErun_move_oops_climate_0_04_HYBR_TAC4.Rdata')