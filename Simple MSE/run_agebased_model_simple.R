...
run.agebased.simple <- function(year,Fin, seed = 100){
  # Constant parameters
  ...
  # }
  # 
  df <- load_data_Fmsy(100)
  F0 <- rep(Fin, each = df$nyear)
