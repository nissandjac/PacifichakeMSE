...
load_data_quarter <- function(){
  ...
  recruitmat <- matrix(0, nspace, nseason) # 4 is seasonality 
  recruitmat[1,4] <- 0.1 # 10 percent change of spawning north
  recruitmat[2,4] <- 0.9 # 90 percent of spawning south
