...
library(TMB)
compile("runHakeassessment_sel.cpp")

seedz <- 125
set.seed(seedz)
dyn.load(dynlib("runHakeassessment_sel"))
...
simyears <- 2 # Project 30 years into the future (2048 that year)
...
for (time in 1){
  ...
  obj <-MakeADFun(df.new,parms,DLL="runHakeassessment_sel") # Run the assessment 
