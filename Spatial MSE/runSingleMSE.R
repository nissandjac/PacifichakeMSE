...
df <- load_data_seasons(nseason = 4, nspace = 2,
                           nsurvey= 4, movemaxinit = 0.5, movefiftyinit = 5) # Prepare data for operating model 


###### Run the MSE using the data above #####
ls <- fnMSE(df, simyears = 30, TAC = 1, nruns = 1, seeds = 100) # TAC 1) HCR, 2) JTC, 3) Realized catch
